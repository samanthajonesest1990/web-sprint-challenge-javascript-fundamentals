...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals) {
    const animalNamesLowercase = zooAnimals.map(animal => animal.animal_name.toLowerCase());
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals) {
    const lowPopulationAnimalsArray = zooAnimals.filter(animal => animal.population < 5);
    return lowPopulationAnimalsArray;
  }
  ...
  */
  ...
  function USApop(zooAnimals) {
    const totalPopulation = zooAnimals.reduce((accumulator, animal) => accumulator + animal.population, 0);
